  ...
  <v-container class="pt-10 pb-0" fluid>
    <v-row justify="center">
      <v-col cols="12" sm="8" md="5" lg="4">
        <v-card
          class="elevation-12 frosted-card profile-card"
          rounded="lg"
          color="#000000c4"
        >
          <v-toolbar
            class="v-card-title profile-title"
            flat
            color="transparent"
            dark
          >
...
.profile-title.v-toolbar {
  ...
  background-color: rgba(
    ...
    18,
    0.8
  ) !important; /* Fons fosc per al títol */
  color: #ffffff;
  padding: 12px 24px;
...
.cutive-mono-list :deep(.v-list-item-subtitle) {
  ...
  color: rgba(
    ...
    255,
    0.7
  ) !important; /* Gris clar per a la descripció */
}
